...
export const authSuccess = (authData) => {
    ...
    localStorage.setItem('exparationDate', new Date().getTime() + authData.expiresIn * 1000);
    return {
...
export const auth = (email, password, signUp) => {
    return dispatch => {
        ...
        let url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCQuZp-7On_qRasxY2fIuKP4tpEBGCQonI';
        if (!signUp) url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCQuZp-7On_qRasxY2fIuKP4tpEBGCQonI';
